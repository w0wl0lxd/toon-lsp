...
Install: search "TOON Language" in the Marketplace, or run `code --install-extension toon-format.toon-lsp`. You can also install the VSIX from [Releases](https://github.com/w0wl0lxd/toon-lsp/releases).
